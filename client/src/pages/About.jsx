        ...
        <div className="about-page">
            ...
            <div className="flex-row">
                <div className="about-container"> 
                    ...
                    <h3>Jeff Fraley</h3>
                    <p>
                        <a className="linkedIn" href="https://www.linkedin.com/in/jeff-fraley/">LinkedIn</a>
                    </p>
                ...
                <div className="about-container"> 
                    ...
                    <p>
                        <a className="linkedIn" href="https://www.linkedin.com/in/kristina-vanbergen-desilva/">LinkedIn</a>
                    </p>
                </div>
                ...
                <div className="about-container"> 
                    ...
                    <p>
                        <a className="linkedIn" href="https://www.linkedin.com/in/eric-deleon132/">LinkedIn</a>
                    </p>
                </div>
            </div>
